...
// kernels
static cl_kernel kernel_process = nullptr;
static cl_kernel kernel_magnitude_reduction = nullptr;
static cl_kernel kernel_reduce_final = nullptr;
static cl_kernel kernel_render_frame = nullptr;
static cl_kernel kernel_point_cloud = nullptr;
static cl_kernel kernel_clear_hue = nullptr;
static cl_kernel kernel_point_cloud_hue = nullptr;

// device buffers
static cl_mem d_poly_coeff_real = nullptr;
static cl_mem d_poly_coeff_imag = nullptr;
static cl_mem d_buffer_real = nullptr;
static cl_mem d_buffer_imag = nullptr;
static cl_mem d_buffer_output_frame = nullptr;
static cl_mem d_buffer_partial_max = nullptr;
static cl_mem d_buffer_final_max = nullptr;

// point cloud buffers
static cl_mem d_perm_roots_real = nullptr;
static cl_mem d_perm_roots_imag = nullptr;
static cl_mem d_perm_distinct = nullptr;
static cl_mem d_perm_roots_hue_ind = nullptr;
static cl_mem d_perm_roots_count = nullptr;
...
void render_gpu_set_polynomial(polynomial_t *P) {
  ...
  err = clEnqueueWriteBuffer(queue, d_poly_coeff_real, CL_FALSE, 0,
                             num_coeffs * sizeof(float), coeffs_real, 0, nullptr, nullptr);
  if (err != CL_SUCCESS) {
...
void render_frame_gpu(void) {
  ...
  err = clEnqueueNDRangeKernel(queue, kernel_reduce_final, 1, nullptr,
                               &final_global_size, &reduction_workgroup_size, 0, nullptr, nullptr);
  if (err != CL_SUCCESS) {
...
void render_point_cloud_gpu(complex long double *roots, const size_t *num_distinct,
